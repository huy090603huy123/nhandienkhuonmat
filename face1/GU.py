...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sua.setGeometry(QtCore.QRect(350, 330, 75, 41))
        self.sua.setObjectName("sua")
        self.xoa = QtWidgets.QPushButton(self.centralwidget)
        self.xoa.setGeometry(QtCore.QRect(430, 330, 75, 41))
        self.xoa.setObjectName("xoa")
        self.Back = QtWidgets.QPushButton(self.centralwidget)
        self.Back.setGeometry(QtCore.QRect(520, 330, 75, 41))
        self.Back.setObjectName("Back")
        self.pushButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(610, 330, 75, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sua.setText(_translate("MainWindow", "Sửa"))
        self.xoa.setText(_translate("MainWindow", "Xóa"))
        self.Back.setText(_translate("MainWindow", "Quay Lại"))
        self.pushButton_2.setText(_translate("MainWindow", "Thoát"))
